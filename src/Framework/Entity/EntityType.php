    ...
    public function loadType(): void {
        ...
        foreach ($entityAttributes ?? [] as $attribute) {
            ...
            if ($attribute['get_class']) {
                $class = $this->classContainer->get($attribute['get_class'], [$this], useCache: false);
            ...
            if ($attribute['set_class']) {
                $class = $this->classContainer->get($attribute['set_class'], [$this], useCache: false);
            ...
            if ($attribute['input_list_class']) {
                $class = $this->classContainer->get($attribute['input_list_class'], [$this], useCache: false);
